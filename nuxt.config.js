...
export default {
  ...
  head: {
    titleTemplate:
      "%s | FERREPACIFICO: Herramientas y materiales de construcción",
    title: "FERREPACIFICO: Herramientas y materiales de construcción",
    htmlAttrs: {
      lang: "es",
    },
    meta: [
  ...
  env: {
    GOOGLE_MAPS_API_KEY: "AIzaSyB35RnJ1AEmpDvzD8dYuNsrWCqAdLqdWYE",
  },

  // axios: {
  //   baseURL: 'https://fpacifico.lava.mx/api'
